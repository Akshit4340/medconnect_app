...
export default function ConsultationPage() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col md:flex-row gap-4 p-2 md:p-4">
      {/* Main video area */}
      <div className="flex-1 flex flex-col gap-3 min-h-[50vh]">
        {/* Status bar */}
        ...
        {/* Remote video (main) */}
        <div className="relative flex-1 bg-slate-900 rounded-xl overflow-hidden shadow-sm border border-slate-800">
          <video
            ref={remoteVideoRef}
            autoPlay
            playsInline
          ...
          {callStatus === 'waiting' && (
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white gap-3 p-4 text-center">
              ...
              <p className="text-sm text-slate-300 max-w-sm">
                Waiting for the other participant to assist you. Share this code
                if needed.
              </p>
          ...
          {callStatus === 'connecting' && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-white text-sm animate-pulse bg-slate-900/50 px-4 py-2 rounded-full backdrop-blur-sm">
          ...
          {/* Local video (PiP) */}
          <div className="absolute bottom-4 right-4 w-28 h-40 sm:w-36 sm:h-28 bg-slate-800 rounded-xl overflow-hidden border-2 border-slate-600 shadow-xl transition-all duration-300 hover:scale-105">
            <video
              ref={localVideoRef}
              autoPlay
              muted
